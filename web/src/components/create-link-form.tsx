    ...
    <div className="flex-1 w-full p-6 lg:p-8 bg-gray-100 flex flex-col gap-6 rounded-lg">
      ...
      <form onSubmit={handleSubmit(createLink)} className="flex flex-col gap-4">
        <div className="flex flex-col gap-2">
          <label htmlFor="originalUrl" className="text-gray-500 text-xs leading-xs uppercase peer-focus:text-blue-base">Link Original</label>
          <input 
            type="text" 
            id="originalUrl" 
        ...
        <div className="flex flex-col gap-2">
          ...
          <div className='flex w-full items-center border border-gray-300 rounded-lg p-4 text-gray-400'>
            <span className='inline-block pointer-none:'>brev.ly/</span>
            <input
            type="text"
            id="shortUrl"
            {...register('shortUrl')}
